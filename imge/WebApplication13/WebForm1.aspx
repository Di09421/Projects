    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        <table class="auto-style1">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageIndex="3">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="img">
                                    <ItemTemplate>
                    <asp:Image ID="img1" runat="server" ImageUrl='<%# Eval("img") %>' Height="100px" Width="100px" />
